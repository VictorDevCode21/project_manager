...
**Clone repository**
git clone https://github.com/VictorDevCode21/project_manager.git
...
**Optional execution**
If for any unknown reason the application cannot be 
executed with "flutter run", you can also try running 
the command "flutter run -d web-server" which will 
generate an http://localhost that you can enter in 
your preferred browser to run the program.
